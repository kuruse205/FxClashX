...
Future<void> _service(List<String> flags) async {
  ...
  vpn?.handleGetStartForegroundParams = () {
    try {
      ...
      // Fallback minimal
      return json.encode({"title": "FlClashX", "server": "", "content": ""});
    }
  };
  ...
  try {
    ...
    final globalHeader = globalState
        .config.currentProfile?.providerHeaders['flclashx-globalmode'];

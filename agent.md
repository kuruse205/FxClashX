...
- GitHub release pre-release tags now build Android, Windows, Linux, and unsigned macOS artifacts; stable tags still keep strict signing/notarization behavior.
